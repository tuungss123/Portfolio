...
const GtWork = () => {
    ...
    return(
        <div className="flex xs:flex-col xs:items-center lg:items-start lg:flex-row w-[75%] bg-white rounded-xl mb-8 sticky top-10 z-10">
            ...
            <div className="flex flex-col justify-between xs:w-full lg:w-[50%] p-5 pt-2 pb-1 ">
                <div className='flex flex-col'>
                    <p className="text-[30px] font-bold">GT Footwear</p>
                    <p className="text-[20px] text-gray-500">An e-commerce website for sneakers.</p>
                    <div className="flex mt-2">
                        ...
                        <div className={`flex flex-row ${languageHover}`}>
                            ...
                            <p className='font-medium text-[14px]'>TailwindCSS</p>
                        </div>
                    </div>
                </div>
