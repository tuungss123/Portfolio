        ...
        <div className=" flex xs:flex-col xs:items-center lg:items-start lg:flex-row w-[75%] bg-[#571212] rounded-xl mb-8 sticky top-20 z-20 shadow-md shadow-gray-600 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300 ...">
            ...
            <div className="flex flex-col justify-between xs:w-full lg:w-[50%] p-5 pt-2 pb-1 ">
                <div className='flex flex-col'>
                    <p className="text-[30px] font-bold text-white">Cafe IMS</p>
                    <p className="text-[20px] text-gray-300">An inventory management system for a Cafe.</p>
                    <div className="flex mt-2">
                        ...
                        <div className={`flex flex-row ${languageHover}`}>
                            ...
                            <p className='font-medium text-[14px] text-white'>MaterialUI</p>
                        </div>
                    </div>
                </div>
