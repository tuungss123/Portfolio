...
const GtWork = () => {
    ...
    return(
        <div className="flex xs:flex-col xs:items-center lg:items-start lg:flex-row w-[75%] bg-black rounded-xl mb-8 sticky top-10 z-10 shadow-md shadow-gray-600 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 duration-300 ...">
            ...
            <div className="flex flex-col justify-between xs:w-full lg:w-[50%] p-5 pt-2 pb-1 ">
                ...
                <div className={`flex xs:flex-col lg:flex-row xs:mt-5 sm:mt-6 `}>
                    ...
                    <a href='https://gt-footwear-deployed-1.onrender.com/' target='_blank'>
